...
public class ProductDAO {
  ...
  public ProductVO getProduct(String pseq) {
    ...
    try {
      ...
      if (rs.next()) { 
        ...
        product.setImage(rs.getString("image"));
        product.setfImage(rs.getString("fImage"));
        product.setsImage(rs.getString("sImage"));
        product.settImage(rs.getString("tImage"));
  ...
  public int insertProduct(ProductVO product) {
    ...
    String sql = "insert into product (" +
        "pseq, kind, name, price1, price2, price3, content, image,fImage,sImage,tImage) " +
    ...
    try {
      ...
      pstmt.setString(8, product.getfImage());
      pstmt.setString(9, product.getsImage());
      pstmt.setString(10, product.gettImage());
  ...
  public int updateProduct(ProductVO product) {
    ...
    String sql = "update product set kind=?, useyn=?, name=?" +
        ", price1=?, price2=?, price3=?, content=?, image=?,fImage=?,sImage=?,tImage=?, bestyn=? " +
        "where pseq=?";
    ...
    try {
      ...
      pstmt.setString(10, product.getfImage());
      pstmt.setString(11, product.getsImage());
      pstmt.setString(12, product.gettImage());
      pstmt.setString(13, product.getBestyn());
      pstmt.setInt(14, product.getPseq());
      result = pstmt.executeUpdate();
    } catch (Exception e) {
      e.printStackTrace();
    } finally {
