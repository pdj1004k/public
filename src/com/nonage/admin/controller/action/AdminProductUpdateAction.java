...
public class AdminProductUpdateAction implements Action {
  ...
  public void execute(HttpServletRequest request, HttpServletResponse response)
    ...
    if(multi.getFilesystemName("fImage")==null){
        productVO.setfImage(multi.getParameter("nonmakeImg"));
      }else{
        productVO.setfImage(multi.getFilesystemName("fImage"));
      }
    if(multi.getFilesystemName("sImage")==null){
        productVO.setsImage(multi.getParameter("nonmakeImg"));
      }else{
        productVO.setsImage(multi.getFilesystemName("sImage"));
      }
    if(multi.getFilesystemName("tImage")==null){
        productVO.settImage(multi.getParameter("nonmakeImg"));
      }else{
        productVO.settImage(multi.getFilesystemName("tImage"));
      }
